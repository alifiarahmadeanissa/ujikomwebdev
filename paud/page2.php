...
<body id="page-top">
    ...
    <!-- Header -->
    <h1 style="margin-top:120px;" class="text-center text-uppercase mb-0">TIMELINE PAUD CERIA</h1><br>
    <!-- Icon Divider-->
        ...
        <div class="page-timeline">
            <div class="vtimeline-point">
                ...
                <div class="vtimeline-block">
                    <span class="vtimeline-date">June 25, 2017</span>
                    <div class="vtimeline-content">
                        <a href="#"><img src="assets/img/cie.jpg" alt="" class="img-fluid mb20"></a>
                        <a href="#">
                        ...
                        <p>
                            Saling menghargai perbedaan satu sama lain, tidak memandang warna kulit maupun suku
                        </p><br>
                    </div>
                </div>
            </div>
            ...
            <div class="vtimeline-point">
                ...
                <div class="vtimeline-block">
                    ...
                    <div class="vtimeline-content">
                        <div class="vtimeline-block">
                            <a href="#"><img src="assets/img/main.png" alt="" class="img-fluid mb20"></a>
                        </div>
                        <a href="#">
                            <h3>Hari Pertama Masuk PAUD | Lagu Anak Sholeh, Anak Berbaris, Lagu OtekOtek, Tepuk Bebek, Tepuk Ayam</h3>
                        </a>
                        <ul class="post-meta list-inline">
                            <li class="list-inline-item">
                                <i class="fa fa-user-circle-o"></i> <a href="#">Zizi Humaira</a>
                            </li>
                            <li class="list-inline-item">
                                <i class="fa fa-calendar-o"></i> <a href="#">29 June 2017</a>
                            </li>
                        ...
                        <p>
                            Hari pertama masuk PAUD anak-anak bernyanyi, menari, dan berkomunikasi satu sama lain.
                        </p><br>
                    </div>
                </div>
            </div>
            <div class="vtimeline-point">
                ...
                <div class="vtimeline-block">
                    <span class="vtimeline-date">June 25, 2017</span>
                    <div class="vtimeline-content">
                        <a href="#"><img src="assets/img/kardus.jpg" alt="" class="img-fluid mb20"></a>
                        <a href="#">
                            <h3>Membuat mainan dari Kardus</h3>
                        </a>
                        <ul class="post-meta list-inline">
                            <li class="list-inline-item">
                                <i class="fa fa-user-circle-o"></i> <a href="#">John Doe</a>
                        ...
                        <p>
                            Kali ini anak-anak membuat mainan sendiri dari kardus, anak-anak terlihat senang dan menyukai hasil karya masing-masing.
                        </p><br>
                    </div>
                </div>
            </div>
