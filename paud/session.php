...
<body id="page-top">
    ...
    if (empty($_SESSION['username'])) {
        header("location:loginpaud.php?pesan=belum_login");
    }
    ?>
    ...
    <header class=" text-center" style="margin-bottom: 120px;">
        <h1 style="margin-top:120px;" class="text-center text-uppercase mb-0">SELAMAT DATANG <?php echo $username ?></h1>
        <br>
        <img style="width: 50%;height: 50%;" src="assets/img/6162.jpg" alt="" />
        <br>
        <a href="logoutpaud.php"><button class="btn btn-primary center btn-lg">LOGOUT</button></a>
        <a href="formpaud.php"><button class="btn btn-primary center btn-lg">TAMBAHKAN MURID</button></a>
        <a href="editdeletepaud.php"><button class="btn btn-primary center btn-lg">KOREKSI DATA MURID</button></a></a>
        <br>
    </header>
