    ...
    <body id="page-top">
        ...
        <header class="masthead text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p style="font-style: italic; color: steelblue;" class="masthead-subheading font-weight-light mb-0">"Let's Smile Spark and Shine"</p>
                <img style="width: 50%;height: 50%;" src="assets/img/6162.jpg" alt=""/>
            </div>
            <a href = "loginpaud.php"><button  class="btn btn-primary center btn-lg"  >LOGIN</button></a>
            <a href = "session.php"><button  class="btn btn-primary center btn-lg"  >SUDAH LOGIN</button></a>
        </header>
