    ...
    <table class="table table-bordered container" align="center">
        ...
        while ($data = mysqli_fetch_array($query)) { ?>
            <tr>
                ...
                <td>
                    <a href=editpaud.php?id_murid=<?php echo $data['id_murid']; ?>>Edit</a>
                    <a href=deletepaud.php?id_murid=<?php echo $data['id_murid']; ?>>Hapus</a>
                </td>
            <?php
        } ?>
    </table>
    <a align="center" href="formpaud.php">jika ingin menambahkan data klik disini</a>
