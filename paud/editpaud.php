...
<body id="page-top">
    ...
    <div style="margin-top:120px;" class="text-center text-uppercase mb-0">
        <h1>EDIT SISWA</h1>
        <!-- Icon Divider-->
    ...
    $query = mysqli_query($con, "SELECT * from paud where id_murid='$id_murid'");
    $data = mysqli_fetch_array($query);
    ?>
    <form method="POST" action="updatepaud.php">
        <div class="container mb-3">
            <input type="hidden" class="form-control" name="id_murid" value="<?php echo $data['id_murid']; ?>"><br>
            Nama : <br><input type="text" class="form-control" name="nama" placeholder="Nama Siswa" value="<?php echo $data['nama']; ?>"><br>
            Kelompok : <br><input type="text" class="form-control" name="kelompok" placeholder="Kelompok" value="<?php echo $data['kelompok']; ?>"><br>
            Umur : <br><input type="text" class="form-control" name="umur" placeholder="umur" value="<?php echo $data['umur']; ?>"><br>
            <div align="center">
                <input type="submit" class="btn btn-primary center btn-lg" name="submit" value="SELESAI">
            </div>
        </div>
