...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container-lg d-flex align-item-up flex-column">
            <h1 class=" text-uppercase">Gallery</h1> <br>
            <div class="row">
                <div class="col">
                <img src="https://asset.kompas.com/crops/i3niE2HlFt1f7zBfPggkpASxFmE=/0x96:1000x596/750x500/data/photo/2019/11/19/5dd3615da661c.jpg" class="img-thumbnail" alt="...">
                </div>
                <div class="col">
                <img src="https://res.cloudinary.com/dk0z4ums3/image/upload/v1539159168/attached_image/berkat-pendidikan-anak-usia-dini-masa-depan-lebih-terjamin.jpg" class="img-thumbnail" alt="">
                </div>
                <div class="col">
                <img src="https://sevima.com/wp-content/uploads/2021/11/Pendidikan-Anak-Usia-Dini-PAUD-e1636359912799.jpeg" class="img-thumbnail" alt="">
                </div>
            </div>
        </div>
        </header>
